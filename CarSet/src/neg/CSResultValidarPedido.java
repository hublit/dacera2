 ...
 * @author depr102
 */
public class CSResultValidarPedido extends javax.swing.JPanel
{
    /** Creates new form ABResultBuscarPedido */
    public CSResultValidarPedido(String query)
    {
            ...
            if ((fila > -1) && (columna > -1))
            {
               ...
               CSEditarPedido editarC = null;
                    try {
                        ...
                        Logger.getLogger(CSResultValidarPedido.class.getName()).log(Level.SEVERE, null, ex);
                    }
