...
public class CSDesktop2 extends JFrame
{
  ...
  public  CSDesktop2(String usuario) throws UnknownHostException
  {
      ...
      elementoAcerca.addActionListener(
         ...
         new ActionListener() {  // clase interna an�nima
            ...
            public void actionPerformed( ActionEvent evento )
            {
               JOptionPane.showMessageDialog(CSDesktop2.this,
                  "                         CarSet version 3.3.0",
