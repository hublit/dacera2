...
public class CSFacturaProveedor  extends JPanel
{
    ...
    private void jToggleButtonClienteActionPerformed(java.awt.event.ActionEvent evt) {
 ...
 public Dimension getPreferredSize()
   {
    ...
    private void LanzarFactura(int numero)
    {
        ...
        String proveedor = new String(jTextCliente.getText());
        Proveedor oProveedor = new Proveedor();
        BeanCliente beanCliente = new BeanCliente();

        proveedorID = oProveedor.getProveedorID(proveedor);
        beanCliente = oProveedor.getDatosFacturaCliente(clienteID);
        ...
        else
        {
            String query = "SELECT DISTINCT pe.pe_num, pe.pe_fecha, pe.pe_servicio_origen, pe.pe_servicio_destino, " +
                           ...
                           "pe.pe_descripcion, tp.tp_tarifa, sp_entrada_campa, sp_campa " +
                           "FROM pe_pedidos pe, pp_pedidos_proveedores pp, tp_tarifas_proveedores, sp_servicios_proveedores sp " +
