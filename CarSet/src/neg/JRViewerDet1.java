 ...
 */
public class JRViewerDet1 extends javax.swing.JPanel implements JRHyperlinkListener
{
	private static final Log log = LogFactory.getLog(JRViewerDet1.class);
	...
	public JRViewerDet1(String fileName, boolean isXML) throws JRException
	{
	...
	/** Creates new form JRViewer */
	public JRViewerDet1(InputStream is, boolean isXML) throws JRException
	{
		this(is, isXML, null);
	}
	...
	/** Creates new form JRViewer */
	public JRViewerDet1(JasperPrint jrPrint)
	{
		this(jrPrint, null);
	}
	...
	/** Creates new form JRViewer */
	public JRViewerDet1(String fileName, boolean isXML, Locale locale) throws JRException
	{
	...
	/** Creates new form JRViewer */
	public JRViewerDet1(InputStream is, boolean isXML, Locale locale) throws JRException
	{
	...
	/** Creates new form JRViewer */
	public JRViewerDet1(JasperPrint jrPrint, Locale locale)
	{
	...
	/** Creates new form JRViewer */
	public JRViewerDet1(String fileName, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException
	{
	...
	/** Creates new form JRViewer */
	public JRViewerDet1(InputStream is, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException
	{
		initResources(locale, resBundle);
	...
	/** Creates new form JRViewer */
	public JRViewerDet1(JasperPrint jrPrint, Locale locale, ResourceBundle resBundle)
	{
		initResources(locale, resBundle);
	...
	*/
	class PageRenderer extends JLabel
	{
		...
		JRViewerDet1 viewer = null;

		public PageRenderer(JRViewerDet1 viewer)
		{
			this.viewer = viewer;
		}
