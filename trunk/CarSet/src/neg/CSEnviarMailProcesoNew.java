    ...
    public static void main(BeanCorreoCliente mail, String email, String nombre)
    {
        ...
        try{
            ...
            if(rs_mail != null)
            {
                ...
                htmlText = htmlText +"<tr><td colspan='2' align='justify'><font size='-1' face='Helvetica'><i> La anulación del pedido una vez tramitado incurrirá en gastos de cancelación, asumidos por el cliente, que supondrán como máximo el 75 % del importe. ";
